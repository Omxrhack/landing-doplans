...
function ProblemRow({
  ...
  return (
    ...
    >
      ...
      {/* Right — desktop only */}
      <div className="hidden lg:flex lg:col-span-5 flex-col justify-center gap-2 pl-8 border-l border-border">
        ...
        {isInView && (
          <TypingText
            ...
            className="text-fg font-display font-semibold text-xl not-italic"
          />
        )}
      </div>
